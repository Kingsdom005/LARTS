...
This repository provides an artifact package accompanying our research on the LARTS framework.
...
# (replace b7bab04fd9aa with your ubuntu20.04 image)
...
sudo apt-get install -y build-essential bison flex unzip
sudo apt-get install -y texinfo
sudo apt-get install -y python3.8 python3.8-dev
sudo apt-get install -y python-is-python3
sudo ap-gett install -y libgmp-dev libmpfr-dev libmpc-dev
...
All current development and testing is conducted using QEMU. Moving forward, our team will conduct testing on **physical hardware** and publish relevant test data to advance operating system research and development.
